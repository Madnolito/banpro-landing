...
export default function Ventajas() {
  ...
  return (
    <section id="ventajas" className="relative overflow-hidden bg-[#111111] py-24 lg:py-32 scroll-mt-20">
      {/* Subtle radial glow */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="h-[500px] w-[800px] rounded-full bg-brand-primary/5 blur-3xl" />
      </div>
        ...
        <div className="relative flex flex-col items-stretch gap-6 md:flex-row md:items-center">
            ...
            <div className="h-full rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
              ...
              <div className="flex flex-col gap-3">
                {CON_ITEMS.map(({ label, Icon }) => (
                  <div
                    key={label}
                    className="flex items-center gap-3 rounded-xl border border-white/5 bg-white/5 px-4 py-4"
                  >
          ...
          <FadeIn delay={0.3} dir="right" className="flex-1">
            <motion.div
              ...
              className="relative h-full rounded-2xl border-2 border-brand-primary bg-white/5 p-8 backdrop-blur-sm ring-1 ring-brand-primary/30 ring-offset-2 ring-offset-transparent"
            >
              {/* BANPRO badge */}
